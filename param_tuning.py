...
def cli():
    ...
    # For responsibility areas only
    parser.add_argument("-nc", "--n_clusters", type=int, help="number of clusters", default=1)
    parser.add_argument("-cm", "--cluster_method", type=str, help="clustering method", default="spectral")
    parser.add_argument(
        "-am", 
        "--adjacency_matrix", 
        type=str, 
...
def trial_one_seed(
    ...
    # Reset the environment before creating the agent
    env.reset()
    test_env.reset()
